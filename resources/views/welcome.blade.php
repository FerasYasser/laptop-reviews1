...
<!-- <button type="sumbit" id="btn"></button> -->
    ...
    <!-- <button type="button" id="home"><a href="/">Home</a></button> -->
    	<button type="button" >  <a href="{{url('category')}}?var=Dell">Dell</button>
        <button type="button"> <a href="{{url('category')}}?var=hp">hp</button>
        <button type="button">hawawi</button>
        <button type="button"> <a href="{{url('category')}}?var=asus">asus</button>
